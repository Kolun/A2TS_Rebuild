     ...
     for( int i = 0; ( i < I_ARGS_IN_POS ) && notError; ++i )
     {
       ...
       if ( current_end != -1 )
       {
         ...
         switch( i )
         {
           ...
           case 0:
             args_pos.posX = arg.toInt( &notError, 10 );
             //заполнение posX
             break;

           case 1:
             args_pos.posY = arg.toInt( &notError, 10 );
             //заполнение posY
             break;

           case 2:
             args_pos.posZ = arg.toInt( &notError, 10 );
             //заполнение posZ
             break;
     ...
     for( int i = 0; ( i < I_ARGS_IN_OTH ) && notError; ++i )
     {
       ...
       if ( current_end != -1 )
       {
         ...
         switch( i )
         {
           ...
           case 0:
             args_oth.posX = arg.toInt( &notError, 10 );
             //заполнение posX
             break;

           case 1:
             args_oth.posY = arg.toInt( &notError, 10 );
             //заполнение posY
             break;

           case 2:
             args_oth.posZ = arg.toInt( &notError, 10 );
             //заполнение posZ
             break;
